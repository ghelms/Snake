...
def food(x, y):
    surf_food = pygame.transform.rotate(tail_img, angle)
    screen.blit(surf_food, (x, y))
...
while running:
    ...
    #The coordinates for the tail are the same as the ones for the snake 18 while-loops ago. This is done by indexing.
    tail_x = log["Snake_x"][log["Count"][counter - 2]]
    tail_y = log["Snake_y"][log["Count"][counter - 2]]
    tail_angle = log["Snake_angle"][log["Count"][counter - 2]]
